      ...
      const result = await simulateRoute(
        isManualMode
          ? {
              ...
              commodity_type: shipmentProfile.commodityType,
              goods_description: shipmentProfile.goodsDescription,
              weight_kg: shipmentProfile.weightKg,
              volume_cbm: shipmentProfile.volumeCbm,
              pieces: shipmentProfile.pieces,
              declared_value_usd: shipmentProfile.declaredValueUsd,
              pallet_count: shipmentProfile.palletCount,
              temperature_controlled: shipmentProfile.temperatureControlled,
              fragile: shipmentProfile.fragile,
              hazardous: shipmentProfile.hazardous,
              service_level: shipmentProfile.serviceLevel,
              insurance_required: shipmentProfile.insuranceRequired,
